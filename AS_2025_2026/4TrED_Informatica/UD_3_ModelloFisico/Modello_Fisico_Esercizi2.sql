...
-- Esercizio 11
-- Contare quanti prestiti sono stati effettuati da ogni classe.
-- Mostrare la classe e il numero di prestiti.



-- Esercizio 12
-- Visualizzare solo le classi che hanno effettuato almeno 2 prestiti.
-- Usare GROUP BY e HAVING.



-- Esercizio 13
-- Per ogni autore, contare quanti libri sono presenti nel database.
-- Mostrare nome autore, cognome autore e numero di libri.



-- Esercizio 14
-- Per ogni autore, contare quanti prestiti sono stati effettuati sui suoi libri.
-- Usare l'equi join tra autore, libro e prestito.



-- Esercizio 15
-- Visualizzare gli autori i cui libri sono stati prestati almeno 2 volte.
-- Mostrare nome autore, cognome autore e numero di prestiti.